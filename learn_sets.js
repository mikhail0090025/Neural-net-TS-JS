...
var gen1 = new Generation(9, 2, 3, 10, RoundMethod.ZeroAndOne, RoundMethod.Tanh, RoundMethod.ZeroAndOne, 50, 0.001, db1);
// SQUARE OF A NUMBER
var db2 = new LearningDB(2, 1);
var difference2 = 10;
for (var i = -difference2; i <= difference2; i++) {
    var num = i / difference2;
    db2.AddPair([num, num < 0 ? 1 : 0], [num * num]);
    // Input 1 - number, square we want to get
    // Input 2 - Is or not positive
}
var gen2 = new Generation(2, 1, 5, 20, RoundMethod.DontRound, RoundMethod.DontRound, RoundMethod.Tanh, 50, 0.001, db2);
// Returns SQRT(input) - 0.5
var db3 = new LearningDB(1, 1);
var difference3 = 10;
for (var i = 0; i <= difference3; i++) {
    var num = i / difference3;
    db3.AddPair([num], [Math.sqrt(num) - 0.5]);
}
var gen3 = new Generation(1, 1, 10, 30, RoundMethod.DontRound, RoundMethod.Tanh, RoundMethod.ZeroAndOne, 50, 0.001, db3);
